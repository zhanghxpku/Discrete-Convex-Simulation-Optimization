...
plt.legend([curve1,curve2,curve5,curve3,curve4],
           ["AS","EAS","lil'UCB","y = O(log N)","y = Const"] )
plt.xlabel("N")
plt.ylabel("Expected simulation cost")
# plt.title("Queueing Model")
# plt.ylim( [0, 300000] )
# plt.savefig("./results/queue/queue_new_new.png",bbox_inches='tight', dpi=300)
plt.title("Artificial Convex Model")
plt.ylim( [0, 600000] )
plt.savefig("./results/sqrt_sep/sep_new_new.png",bbox_inches='tight', dpi=300)
