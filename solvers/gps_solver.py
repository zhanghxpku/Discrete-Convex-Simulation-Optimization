...
def GPS_solver(F, params):
    ...
    # Step 0
    # Store number of evaluations and empirical mean and variance
...
def ARS(x_0, records, a, b, sig, params):
    ...
    while True:
        ...
        cond_exp, cond_var = cond_prob(y, x_0, records, a, b, sig)
...
def MCCS(x_0, records, a, b, sig, params):
    ...
    for t in range(T):
        ...
        # cond_exp_new, cond_var_new = cond_prob(z, x_0, records, a, b, sig)
...
def cond_prob(x, x_0, records, a, b, sig):
    """
    ...
    # Compute weights
    lamb = Lambda(x, x_0, b)
    gamma = Gamma_vec(x, x_0, a)
    Gamma = Gamma_mat(x_0, a)
